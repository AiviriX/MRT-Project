    ...
    return (
        <header className="">
            <nav className='bg-white border-gray-200 dark:bg-gray-900'>
                <ul className=''>
                    <li> <a className='font-family: sans-serif'> MRT/LRT Train Management System</a></li>               
                    <li> <a className='font-sans' href=""> Home </a></li>
                    <li> <a > News </a> </li>
                    <li> <a > Contact </a> </li>
                    <li> <a > Train Lines </a></li>
