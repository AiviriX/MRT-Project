...
export const StationsManager = () => {
  ...
  const [trainLine, setTrainLine] = useState('MRT-3');
...
<div className="flex flex-col lg:flex-row bg-red-200">
  
  <aside className=" lg:w-1/2 lg:h-screen bg-gray-800 text-white p-6 space-y-6">
  ...
  <div className="w-full lg:w-1/2">
    <div className="flex flex-col items-center w-full space-y-1 px-4 lg:border-8 lg:rounded">
      <div className="w-full lg:max-w-64">
        ...
        <select
          className="w-full lg:w-1/2 px-3 py-2 text-gray-700 border rounded-lg focus:outline-none"
        ...
        <div className="mb-8 justify-center items-center">
          ...
          {selectedMarker && selectedMarker.coordinates ? (
            <div className="space-y-2">
              ...
              {stationAction === 'update' && (
                <StationModal isOpen={true} onRequestClose={() => setStationAction('')} stationData={selectedMarker} mode="update" />
              )}
              <button
  ...
  <div className="m-2 bg-white border border-gray-200 rounded-lg shadow dark:bg-white-800 dark:border-gray-700 relative z-0 h-[625px] w-[screen] lg:w-[50%]">
